...
<body>
    <header class="site-header">
        ...
        <nav class="header-nav">
            <button onclick="window.location.href='upload.php'">Subir Documento</button>
            <button onclick="window.location.href='user_management.php'">Gestionar Usuarios</button>
